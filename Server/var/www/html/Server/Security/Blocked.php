    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">GeniSysAI Server UI Blocked IPs</h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-ban fa-fw"></i> Blocked IPs
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?=$value["id"]; ?></td>
                                                <td><?=$value["ip"]; ?></td>
                                                <td style="width: 15%;"><?=date("Y-m-d H:i:s", $value["timeAt"]); ?></td>
                                            </tr>
