<?php 
    ...
    class TASS
    {
        ...
        public function getAccessConfs()
        {
        ...
        {   
            ...
            ");
            $pdoQuery->execute([
                ':tassID' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'deviceID', FILTER_SANITIZE_NUMBER_INT))
            ]);
            $pdoQuery->closeCursor();
            $pdoQuery = null;
            ...
            return [
                "Response"=>"OK",
                "Redirect"=>"/GeniSysAI/Access-Camera/"
            ];
        ...
        {   
            ...
            $pdoQuery->execute([
                ':tassID' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'deviceID', FILTER_SANITIZE_NUMBER_INT)),
                ':tassAddress' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'API', FILTER_SANITIZE_STRING))
            ]);
            ...
            $pdoQuery->execute([
                ...
                ':socketIP' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'socketIP', FILTER_SANITIZE_STRING)),
                ':socketPort' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'socketPort', FILTER_SANITIZE_STRING)),
                ':streamIP' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'StreamIP', FILTER_SANITIZE_STRING)),
                ':streamPort' => $this->_GeniSys->_helpers->oEncrypt(filter_input(INPUT_POST, 'StreamPort', FILTER_SANITIZE_STRING)),
...
if(filter_input(INPUT_POST, 'ftype', FILTER_SANITIZE_STRING)=="updateTassLocalID"):
        die(json_encode($_TASS->updateTassLocalID()));
endif;

if(filter_input(INPUT_POST, 'ftype', FILTER_SANITIZE_STRING)=="updateTASSlocal"):
