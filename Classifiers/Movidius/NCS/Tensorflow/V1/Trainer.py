...
# Contributors:
# Title:         Movidius NCS1 Classifier Trainer Class
# Description:   Movidius NCS1 training functions for the AML/ALL Detection System Movidius
#                NCS1 Trainer.
# License:       MIT License
...
class Trainer():
    """ AML/ALL Detection System Movidius NCS1 Classifier Trainer Class

    Trains the AML/ALL Detection System Movidius NCS1 Trainer.
    """

    def __init__(self):
        """ Initializes the Movidius NCS1 Classifier Trainer Class """
...
def run():
    """ AML/ALL Detection System Movidius NCS1 Classifier Trainer Runner

    Runs the AML/ALL Detection System Movidius NCS1 Classifier Trainer.
    """

    humanStart, clockStart = Trainer.Helpers.timerStart()

    Trainer.Helpers.logger.info(
        "AML/ALL Detection System Movidius NCS1 Trainer started.")
    ...
    Trainer.Helpers.logger.info(
        "AML/ALL Detection System Movidius NCS1 Trainer ended in " + str(difference))
